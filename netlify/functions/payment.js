...
//         if (error) {
//             throw new Error(`Failed to create pending order in database: ${error.message}`);
//         }
...
//                 total_amount: price,
//                 subject: subject,
//                 notify_url: 'https://fancy-peas-roll.loca.lt/.netlify/functions/alipay-notify'
//             },
//         });
...
//             statusCode: 200,
//             headers: headers,
//             body: JSON.stringify({ success: true, qrCodeUrl: result.qrCode, outTradeNo: outTradeNo })
//         };
//     } catch (error) {
